...
.mod-lesson .progress_bar_completed {
    ...
    background-image: url(https://e-tutor.itsa.org.tw/e-Tutor/mod/lesson/completed.gif);
...
.mod-lesson .progress_bar_todo {
    /*  Example Use of Image
    background-image: url(https://e-tutor.itsa.org.tw/e-Tutor/mod/lesson/todo.gif);
    background-repeat: repeat-x;
    background-position: center;
    */
    background-color: red;
...
.mod-lesson .progress_bar_token {
    /*  Example Use of Image
    background-image: url(https://e-tutor.itsa.org.tw/e-Tutor/mod/lesson/token.gif);
...
.yui-skin-sam .yui-panel .hd{padding:0 10px;font-size:93%;line-height:2;*line-height:1.9;font-weight:bold;color:#000;background:url(https://e-tutor.itsa.org.tw/e-Tutor/lib/yui/assets/skins/sam/sprite.png) repeat-x 0 -200px;}
.yui-skin-sam .container-close{border-color: #45c;position:absolute;top:5px;right:6px;width:25px;height:15px;background:url(https://e-tutor.itsa.org.tw/e-Tutor/lib/yui/assets/skins/sam/sprite.png) no-repeat 0 -300px;cursor:pointer;}
.yui-skin-sam .yui-simple-dialog .bd .yui-icon{background:url(https://e-tutor.itsa.org.tw/e-Tutor/lib/yui/assets/skins/sam/sprite.png) no-repeat 0 0;width:16px;height:16px;margin-right:10px;float:left;}
